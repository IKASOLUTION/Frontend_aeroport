...
@Component({
    ...
    standalone: true,
    imports: [NgClass, InputGroupModule, InputGroupAddonModule, InputTextModule, DropdownModule, FormsModule, CalendarModule, ButtonModule, RippleModule, RadioButtonModule, CheckboxModule]
})
