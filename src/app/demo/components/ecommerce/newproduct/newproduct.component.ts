...
@Component({
    ...
    standalone: true,
    imports: [FormsModule, InputTextModule, EditorModule, FileUploadModule, SharedModule, NgIf, NgFor, ButtonModule, RippleModule, ChipModule, DropdownModule, InputSwitchModule]
})
