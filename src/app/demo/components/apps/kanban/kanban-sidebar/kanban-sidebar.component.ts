...
@Component({
    ...
    standalone: true,
    imports: [NgIf, SidebarModule, SharedModule, FormsModule, InplaceModule, TooltipModule, InputTextModule, ButtonModule, RippleModule, OverlayPanelModule, NgFor, InputTextareaModule, CalendarModule, ProgressBarModule, CheckboxModule, NgClass, AutoCompleteModule, AvatarModule]
})
