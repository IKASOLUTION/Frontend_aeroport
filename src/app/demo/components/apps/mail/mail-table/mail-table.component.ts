...
@Component({
    ...
    standalone: true,
    imports: [TableModule, SharedModule, ButtonModule, RippleModule, MenuModule, InputTextModule, NgIf, NgClass, AvatarModule, TooltipModule, DialogModule, MailReplyComponent]
})
